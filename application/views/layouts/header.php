...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('assets/adminlte/plugins/overlayScrollbars/cssOverlayScrollbars.min.css');?>">
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active"><a href="#">Boxed Layouts</a></li>
                    </ol>
                </div>
            </div>
        </div>
