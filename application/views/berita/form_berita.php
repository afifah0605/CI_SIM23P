            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Daftar Berita</a>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control summernote" name="isi_berita" placeholder="Isi Berita" required></textarea>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" name="tgl_publish" placeholder="tgl_publish" required>
                    </div>
                </div>
